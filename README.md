...
|                              **Skills**                             |                                            **Tools**                                          |                           **Topics**                          |
|---------------------------------------------------------------------|:---------------------------------------------------------------------------------------------:|---------------------------------------------------------------|
|                    Full Stack Data Science (NLP, MLOps, DE)             |                     Pytorch<br>Transformers<br>Kubernetes<br>Docker<br>FastAPI<br>WebScraping                           | [DD.ai](https://dd-ai-predict.streamlit.app/predict) <br> [A Platform for Drug-Drug Interaction (DDI) Prediction](https://www.ischool.berkeley.edu/projects/2023/ddai)           |
